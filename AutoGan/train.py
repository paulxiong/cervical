...
def main1():
    ...
    train_loader = dataset.train
   # print("train_loader_dtype:",train_loader.dtype)
    print("train_loader:",train_loader)
    #print("train_loader:",train_loader.type)
    ...
    # initial
    fixed_z = torch.cuda.FloatTensor(np.random.normal(0, 1, (25, args.latent_dim)))
    #print("fixed_z:",fixed_z)
    print("fixed_z_type:",type(fixed_z))
    print("type:", fixed_z.type)
    gen_avg_param = copy_params(gen_net)
   # print("gen_avg_param:",gen_avg_param)
    start_epoch = 0
    best_fid = 1e4
