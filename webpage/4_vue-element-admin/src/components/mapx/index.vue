<template>
  <div :ref="id" class="magnifier-box" :class="vertical?'vertical':''" @mouseup="mousemove" @mouseover="mouseover" @mouseleave="mouseleave">
    <img v-show="showImg" :src="imgUrl" alt="">
    <div class="mouse-cover" />
    <div v-if="showEidt" class="edit-wrap">
      <span class="rotate-left" @click="rotate('left')" />
      <span class="rotate-right" @click="rotate('right')" />
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initTime() {
      ...
      console.log(this.scale, this.cover.style.width, this.cover.style.height)
