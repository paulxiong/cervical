<template>
  <div>
    ...
    />
    <el-divider content-position="left">阴性</el-divider>
    <el-radio-group v-model="cellRadio" size="mini" class="radio-box">
      <el-radio v-for="cell of cellsOptions" :key="cell.value" :label="cell.value" border style="margin:0 3px 3px 0;">
        {{ cell.label }}
      </el-radio>
    </el-radio-group>
    <el-divider content-position="left">阳性</el-divider>
    <el-radio-group v-model="cellRadio" size="mini" class="radio-box">
      <el-radio v-for="cell of cellsOptions2" :key="cell.value" :label="cell.value" border style="margin:0 3px 3px 0;">
        {{ cell.label }}
      </el-radio>
    </el-radio-group>
    <el-divider content-position="left">其他</el-divider>
    <el-radio-group v-model="cellRadio" size="mini" class="radio-box">
      <el-radio v-for="cell of cellsOptions3" :key="cell.value" :label="cell.value" border style="margin:0 3px 3px 0;">
        {{ cell.label }}
      </el-radio>
    </el-radio-group>
