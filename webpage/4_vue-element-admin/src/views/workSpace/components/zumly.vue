...
export default {
    ...
    methods: {
        method1() {
            ...
            const world ={
              async render() {
                  // let image_src = "https://raw.githubusercontent.com/zumly/website/gh-pages/images/world.png"
                  let image_src = this.msg_inB;
                  alert("boostx in zumly.vue:" + image_src);
                  return `
                  <div class="z-view world">
                    <img src= ${image_src} />
                  </div>                      
