...
export default {
  ...
  data() {
    return {
      resetContent: '<h1 style="text-align: left;">注册验证码</h1><p>&nbsp;</p><p style="text-align: left;">尊敬的用户:</p><p style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;您好，您正在使用<span style="color: #3366ff;"><a href="mailto:email@gmail.com邮" target="_blank" rel="noopener">email@gmail.com</a></span>邮箱在讯动医疗页面注册新账号</p><p style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;您的验证码为：<span style="color: red; font-weight: bold;">000000</span><span style="color: green;"> (10分钟内有效)</span></p><h6 style="text-align: left;">&nbsp; &nbsp; <span style="color: #999999;">如果不是本人操作，请您忽略这封邮件。使用中遇到任何问题，请联系我们为您解决，邮箱：xundong_km1@163.com</span></h6><p>&nbsp;</p><hr /><p style="text-align: right;">谢谢！</p><p style="text-align: right;">讯动医疗团队</p>',
      content: '',
      reset: false
    }
  },
  ...
  methods: {
    saveEmailConfig() {
      updateEmail({ 'content': this.reset ? this.resetContent : this.content, 'type': 1 }).then(res => {
        if (res.data.data === 'ok') {
          this.$message({
            message: '注册邮件格式保存成功',
            type: 'success'
