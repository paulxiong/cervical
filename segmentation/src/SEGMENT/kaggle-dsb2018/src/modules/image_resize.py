...
from image_windows import split_image_to_windows, stitch_all_images, split_image_to_windows1
...
def window_images1(images, new_height, new_width):
    """Resize input images into the provided dimensions.
    ...
    resized_images = []
    for img in images:
        resized_images.extend(split_image_to_windows1(img, new_height, new_width))
