...
class NucleiUtility(object):
    ...
    def test_batched_predictions(self, img_df, models):
        ...
        for (batch, sizes) in image_batches(all_images, all_sizes, batch_size):
            ...
            predict_inputs = window_images(batch,self.IMG_HEIGHT, self.IMG_WIDTH)
    ...
    def predict_model_for_test(self, img_df, models, predict_path):
        ...
        for img_df in img_dfs:
            ...
            save_prediction_images2(img_df, predictions_full_size, os.path.join(self.OUTPUT_PATH, predict_path))
            del predictions_full_size
